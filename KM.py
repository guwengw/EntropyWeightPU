# -*- coding: utf-8 -*-
"""
Created on Thu Jun 24 19:51:04 2021
...
def find_nearest_valid_distribution(u_alpha, kernel, initial=None, reg=0):
    ...
    min_v (u_alpha - v)^\top K (u_alpha - v) + reg* v^\top v""" #找到v？
    
    


    P = matrix(2 * kernel) #gram矩阵
    n = kernel.shape[0]  #gram矩阵的行
...
if __name__=='__main__':
    ...
    print (dataset+" class_prior={}".format(prior))
