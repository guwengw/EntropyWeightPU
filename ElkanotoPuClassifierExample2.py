# -*- coding: utf-8 -*-
"""
Created on Mon Jun 28 15:23:25 2021
...
if __name__ == '__main__':
    ...
    fpath = os.path.join(dpath, 'F:/PU/pulearn-master/examples/datasets/breast-cancer-wisconsin.data')
    ...
    n_sacrifice_iter = range(0, len(np.where(y_train == +1.)[0]) - 21, 100)
